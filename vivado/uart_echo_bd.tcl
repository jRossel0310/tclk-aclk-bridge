...
################################################################
# This is a generated script based on design: uart_echo_bd
#
...
# source uart_echo_bd_script.tcl
...
MIO#GPIO0 MIO#GPIO0 MIO#GPIO0 MIO#GPIO0 MIO#GPIO0 MIO#GPIO0 MIO#GPIO0 MIO#GPIO0 MIO#GPIO0 MIO#GPIO0 MIO#PMU GPI 0#DPAUX#DPAUX#DPAUX#DPAUX#PMU GPI 5#PMU GPO 0#PMU GPO 1#PMU GPO 2#PMU GPO 3#GPIO1 MIO#GPIO1\
...
\
  ...
  # Create instance: u_echo, and set properties
  set block_name uart_echo_bd_top
  set block_cell_name u_echo
  if { [catch {set u_echo [create_bd_cell -type module -reference $block_name $block_cell_name] } errmsg] } {
  ...
  # Create instance: dcm_locked_const, and set properties
  set dcm_locked_const [ create_bd_cell -type ip -vlnv xilinx.com:ip:xlconstant:1.1 dcm_locked_const ]
  set_property -dict [list \
    CONFIG.CONST_VAL {1} \
  ...
  [get_bd_pins u_echo/serial_in]
  connect_bd_net -net dcm_locked_const_dout  [get_bd_pins dcm_locked_const/dout] \
  [get_bd_pins rst_ps8_0_99M/dcm_locked]
  ...
  [get_bd_pins u_echo/reset]
  connect_bd_net -net u_echo_serial_out  [get_bd_pins u_echo/serial_out] \
