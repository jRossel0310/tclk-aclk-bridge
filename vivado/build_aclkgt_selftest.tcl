...
add_files -norecurse [list \
    ...
    [file join $rtl_dir aclk_gt_selftest_bd_top.v] \
]
...
set u_aclkgt [create_bd_cell -type module -reference aclk_gt_selftest_bd_top u_aclkgt]
